...
errorMessage: string = '';
  ...
  logAnswers() {
    ...
    const answers = [
      { text: this.answer1, pairId: 1 },
      { text: this.mAnswer1, pairId: 1 },
      { text: this.answer2, pairId: 2 },
      { text: this.mAnswer2, pairId: 2 },
      { text: this.answer3, pairId: 3 },
      { text: this.mAnswer3, pairId: 3 }
    ];
